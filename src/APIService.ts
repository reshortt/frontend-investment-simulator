...
export const doSignup = async (
  ...
  const response = await fetch("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/signup", requestOptions);
...
export const doLogin = async (
  ...
  const response = await fetch("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/login", requestOptions);
...
export const getAccount = async (): Promise<Account | null> => {
  ...
  const response = await fetch(
    "http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getAccount",
    requestOptions
  );
...
export const getUserInfo = async (): Promise<UserInfo | null> => {
  const requestOptions = createRequestAuthorization();
  const response = await fetch(
    "http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getUserInfo",
    requestOptions
  );
...
export const getBalance = async (yesterday: boolean): Promise<number> => {
  const requestOptions = createRequestAuthorization();
  const getBalanceUrl = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getBalance");
...
export const getAssets = async (): Promise<Asset[]> => {
  ...
  const response = await fetch(
    "http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getAssets",
    requestOptions
  );
...
export const getTransactions = async (): Promise<Transaction[]> => {
  ...
  const response = await fetch(
    "http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getTransactions",
    requestOptions
  );
...
export const getCash = async (): Promise<number> => {
  ...
  const response = await fetch(
    "http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getCash",
    requestOptions
  );
...
export const lookupTicker = async (
  ...
  const lookupTickerURL = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/lookupTicker");
...
export async function getHistoricalDividends(
  ...
  const queryURL = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getHistoricalDividends");
...
export async function getStockPriceOnDate(
  ...
  const queryURL = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getStockPriceOnDate");
  queryURL.search = queryParams.toString();
...
export async function getHistoricalPrices(
  ...
  const queryURL = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getHistoricalPrices");
  queryURL.search = queryParams.toString();
...
export const buyAsset = async (
  ...
  const buySharesURL = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/buyAsset");
...
export const sellAsset = async (
  ...
  const sharesString: string = shares.toString();
  const priceString: string = price.toString();
  const sellAssetURL = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/sellAsset");
...
export const getStockPrice = async (
  ...
  const getStockPriceUrl = new URL("http://ec2-18-234-222-155.compute-1.amazonaws.com:3005/API/getStockPrice");
