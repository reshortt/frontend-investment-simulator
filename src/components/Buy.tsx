...
export default function Buy () {
  ...
  console.log("isLoadingPrice is ========>>> ", loadingPrice, " before rendering")
  console.log("isLoadingStock is ========>>> ", loadingStock, " before rendering")
  ...
  return (
    <div>
      ...
      <label> ${(loadingStock || loadingPrice) ? "..." : (price ? price.ask : 0)}</label>
      <br />
      ...
      <label> ${loadingStock || loadingPrice ? "..." : shareCost > 0 ? COMMISSION : 0} </label>
      <br />
